...
class BSBrakeActuation:
    ...
    def __init__(self, parent):
        ...
        self.parent.declare_parameter("brake_cmd_topic", "/control/braking", brake_cmd_descriptor)
        self.brake_cmd_topic = self.parent.get_parameter("brake_cmd_topic").value
        ...
        self.subscriber_handles[self.brake_cmd_topic] = self.parent.create_subscription(BrakingCommand, self.brake_cmd_topic, self.brake_cmd_callback, 1)
        ...
        self.thrd_rbc.start()
        self.parent.get_logger().info("Ready for iBooster power on!")
    ...
    def brake_cmd_callback(self, msg):
        ...
        """
        self.parent.get_logger().info(f"Received {msg} on topic {self.brake_cmd_topic}")
