...
class TrackPublisher(Node):
    ...
    def __init__(self):
        ...
        track = WATrack()
        left_points = [
            [42.96876879357948, -89.50527087819115,0],
            [42.96876879357948, -89.50520019341766,0],
            [42.968766912785256, -89.50511922722255,0],
            [42.96877255516771, -89.50505111280444,0],
            [42.9687622107995, -89.50497143178706,0]
        ]

        right_points = [
            [42.968736820070134, -89.50526959301345,0],
            [42.9687396412628, -89.50520404895076,0],
            [42.968736820070134, -89.50512179757796,0],
            [42.96874246245534, -89.50505111280444,0],
            [42.9687396412628, -89.50496372072085,0]
        ]
