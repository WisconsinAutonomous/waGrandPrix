...
# from stanley_controller_pid import StanleyController
...
#get file path to the path
from wa_simulator.utils import set_wa_data_directory
...
class Controller(Node):
    ...
    def timer_callback(self):
        ...
        global throttle
        global braking
        msg.data = 'Hello Earth: ' + str((steering, throttle, braking))
...
def main(args=None):
    set_wa_data_directory("wasim/data/")
    print(wa.get_wa_data_directory())
    # ---------------
    # Create a system
    ...
    controller = StanleyController(system, vehicle, vehicle_inputs, path)
