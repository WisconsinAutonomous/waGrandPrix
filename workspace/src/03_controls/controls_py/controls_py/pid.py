...
class PIDController(wa.WAController):
    ...
    def __init__(self, system: wa.WASystem, vehicle_inputs: wa.WAVehicleInputs, VehicleState, target_point, lat_controller: 'PIDLateralController' = None, long_controller: 'PIDLongitudinalController' = None):
    ...
    def advance(self, step: float):
        ...
        self._lat_controller.VehicleState = self.VehicleState
        self._long_controller.VehicleState = self.VehicleState
